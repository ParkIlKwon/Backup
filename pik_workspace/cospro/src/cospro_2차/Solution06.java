...
---
#####매개변수 설명
하루 동안 엘리베이터가 멈춘 층이 순서대로 들어있는 
배열 floors가 solution 메소드의 매개변수로 주어집니다.
* floors의 길이는 2 이상 100 이하입니다.
* floors의 원소는 1 이상 100 이하의 자연수이며, 
* 인접한 두 원소의 값이 같은 경우는 주어지지 않습니다.
...
public class Solution06 {
    public int solution(int[] floors) {
        ...
        for (int i = 0; i < floors.length-1; i++) {
			num += Math.abs(floors[i] - floors[i+1]);
		}
        return dist = num;
    }
